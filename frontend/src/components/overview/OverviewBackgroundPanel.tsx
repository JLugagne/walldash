...
interface OverviewBackgroundPanelProps {
...
/**
 * OverviewBackgroundPanel is the edit-mode background picker: bundled samples, a "no
 ...
 */
export const OverviewBackgroundPanel: React.FC<OverviewBackgroundPanelProps> = ({
  value,
  onChange,
  onClose,
}) => {
