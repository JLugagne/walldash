    ...
    <div className="flex flex-col h-full min-h-0">
      <div className="p-3 border-b border-slate-800 space-y-2">
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-500">
          <label className="flex items-center gap-1.5 cursor-pointer select-none">
            ...
            />
            <span>Masquer les appareils placés</span>
          </label>
          <button
            type="button"
            onClick={onRefresh}
            title="Recharger depuis Home Assistant"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-2 space-y-1">
        {loading && devices.length === 0 ? (
          ...
          <div className="p-6 text-center text-xs text-slate-500">Aucun appareil trouvé</div>
        ) : (
          filtered.map((dev) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  {placed && !placing && (
                    <span className="text-emerald-400" title="Déjà placé sur ce niveau">
                  ...
                  <button
                    ...
                    title={placing ? 'Annuler le placement' : 'Placer en cliquant sur le plan'}
      ...
      <div className="px-3 py-2 border-t border-slate-800 text-[11px] text-slate-500 leading-relaxed">
        Glissez un appareil sur le plan, ou cliquez sur la cible puis sur l'emplacement voulu.
      </div>
    </div>
  )
}
